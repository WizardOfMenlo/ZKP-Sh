...
this field is in practice of the form $\ZZ_p$ for $p$ prime, and it is defined by the set of points $(x, y) \in \mathbb{F}^2 \cup \{ \infty \}$ such that\footnote{In fact the one below is
