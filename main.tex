...
\begin{abstract}
    ...
    building up from Interactive Proofs to a fuller vision of the theory. In the process, we will have shown interactive
...
\[ S_G = \{ f: G \to G | \text{ s.t. } f \text{ is a bijection} \} \]
