...
\usepackage{amsthm}
\usepackage{appendix}
\usepackage[landau, sets, probability, complexity]{cryptocode}
...
\begin{definition}
We say that a language $L \in \pol$ if there exist a deterministic TM $M$ and a polynomial $p(\cdot)$ such that both the following hold true:
\begin{enumerate}
