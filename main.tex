...
\usepackage{amsthm}
\usepackage{appendix}
\usepackage[landau, sets, probability]{cryptocode}
...
\[ \texttt{SAT} = \{ \phi : \bin^n \to \bin \, | \, n \in \mathbb{N} \text{ and } \exists a_1 \dots a_n : \phi(a_1, \dots a_n) = 1 \} \]
...
\begin{example}
Consider the two ensembles $\{A_n\}_{n \in \mathbb{N}}$ and $\{B_n\}_{n \in \mathbb{N}}$ where $\prob{A_n = n} = \prob{A_n = n+1} = \frac{1}{2}$, and $\prob{B_n = n} = 1$. So $A_n$ is either $n$ or $n+1$, while $B_n$ always equals $n$. Then $\{A_n\}_{n \in \mathbb{N}}$ and $\{B_n\}_{n \in \mathbb{N}}$ are \textbf{not} computationally indistinguishable
\begin{proof}
...
\begin{definition}
    ...
    \begin{itemize}
        \item For $s$ uniformly drawn from $\bin^n$, the ensembles $\{ F_s(0, 1^n) \}_{n \in \mathbb{N}}$ and $\{ F_s(1, 1^n) \}_{n \in \mathbb{N}}$ are computationally indistinguishable.
