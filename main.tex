...
\section{Conclusion}
In conclusion, in this paper we provided a survey of the theory underlying Zero Knowledge Proofs,
building up from Interactive Proofs to Perfect Zero Knowledge Proofs. In the process, we have shown interactive 
proofs for \texttt{GNI}, and zero knowledge proofs for both \texttt{GI} and \texttt{3COL}. Finally, we have detailed some
applications of the theory, showing various "flavours" of ZKP for the Discrete Logarithm problem that culminated in 
Schnorr Signature. We compounded this with the Secure Remote Protocol, a protocol that uses a similar ZKP in order 
to authenticate without communicating your password to the server. Finally, we have shown a very simple Zero Knowledge
Range Proof, a very general class that has a wide range of applications and is currently one of the hottest avenues of research.
