    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \item Soundness: Let us suppose that $G$ is not 3-colorable. Then the $n$ commited values cannot 
                            ...
                            prover commits, the verifier will reject with probability at least $\frac{1}{|E|}$
        \end{itemize}
...
\texttt{3COL} is a $\mathcal{NP}$-complete language, and as such it is polynomial time reducible to any other problem in $\mathcal{NP}$.
...
it is known that the \texttt{SSUM} problem is actually efficiently solved in many commonly arising cases \cite{flaxmanSolvingMediumDensitySubset2005}, and a such
